...
public class BorderLayoutSample {
    ...
    public static void main(String[] args) {
     ...
     JButton buttonl=new JButton("1");
    frame.add(buttonl, "North");
    buttonl.setPreferredSize(new Dimension(100, 100));
    JButton button2=new JButton("2");
    frame.add(button2, "West");
    CustomComponent c=new CustomComponent(); frame.add(c, "West"); 
    JButton button3=new JButton("3"); 
    frame.add(button3, "South"); 
        JButton button4=new JButton("4"); 
    frame.add(button4, "East");
    button4.setPreferredSize(new Dimension(100, 100));
     JButton button5=new JButton("5"); frame.add(button5);
        //////////////////////////////////////////////////////////////////////
